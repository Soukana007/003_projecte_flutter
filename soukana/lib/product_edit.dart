...
class _ProductEditState extends State<ProductEdit> {
  ...
  int category = 4;  // Category should be an integer
  ...
  Future<void> _fetchProductDetails() async {
    final response = await http.get(Uri.parse('https://store.annymarket.shop/public/api/product_4/${widget.productId}'));
  ...
  Future<void> _updateProduct() async {
    final url = Uri.parse('https://store.annymarket.shop/public/api/product_4/${widget.productId}');
          ...
          child: Column(
            children: <Widget>[
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'ຊື່ລົດໃຫຍ່'),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'ກະລຸນາປ້ອນຊື່ລົດໃຫຍ່';
                  }
                  return null;
                },
              ),
