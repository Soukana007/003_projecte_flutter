...
Future<List<get_Product>> fetchProducts() async {
  final response = await http.get(Uri.parse('https://store.annymarket.shop/public/api/product_4'));
...
Future<void> deleteProduct(int id) async {
  final response = await http.delete(
    Uri.parse('https://store.annymarket.shop/public/api/product_4/$id'),
